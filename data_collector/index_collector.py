...
class IndexCollector:
    ...
    def get_active_pairs(self):
        ...
        try:
            ...
            print(f"Hata: Endeks pariteleri alınamadı - {str(e)}")
            return []
    ...
    def run(self):
        ...
        print("\n" + "="*50)
        print("ENDEKS VERİLERİ TOPLANIYOR")
        print("="*50)
        
        pairs = self.get_active_pairs()
        if not pairs:
            print("İşlenecek endeks verisi yok")
            return
            
        print(f"Toplam {len(pairs)} endeks işlenecek")
